...
The system follows principles taught in the course: linear systems, feature extractors, neural representations, CNNs, Transformers, and statistical modeling.
...
Pass it through CLIP’s vision encoder to obtain a feature vector.

Normalize the vector so it has consistent scale.

Save the embedding for training the classifier.
